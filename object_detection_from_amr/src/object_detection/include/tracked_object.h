/*Corrected parameters of the tracked object**/
//referred: https://github.com/songshan0321/ros_vino/blob/master/include/utilities/kalman.h
...
class TrackedObject {
public:
  TrackedObject(const object_detection::msg::Object& object) : object_(object), kf_x_(0, 1, 2), kf_y_(0, 1, 2), kf_h_(0, 1, 2), kf_w_(0, 1, 2) {
  ...
  void correctState(const object_detection::msg::Object& new_object) {
  ...
  const object_detection::msg::Object& getObject() const { return object_; }
...
private:
  ...
  object_detection::msg::Object object_;
